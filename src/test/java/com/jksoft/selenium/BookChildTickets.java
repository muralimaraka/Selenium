...
public class BookChildTickets extends BaseClass {
	  ...
	  public void bookAdultTicket() {
		  ...
		  objSearchPage.setPassenger("0");
		  objSearchPage.setChildPassenger();
		  objSearchPage.setChildAge();
		  ...
		  String strChildLable=objCheckoutPage.getChildLableInCheckOutPage();
		  
		  Assert.assertEquals(strExpectedPrice, strActualPirce);
		  Assert.assertTrue("Child label exist in checkout page", strChildLable.contains("child"));
